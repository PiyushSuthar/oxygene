...
Alias Transactions implementation on TokenVM

---

Built on the foundation of the HyperSDK focusing on enhancing the TokenVM by introducing key features such as alias-based transactions simplifying borrowing and lending capabilities. We've extended TokenVM to make it more versatile and user-friendly. This layer on TokenVM allows users to transact using aliases instead of complex blockchain addresses. This enhancement simplifies UX making it more accessible to a broader audience. Users can create and manage aliases, linking them to their respective addresses.
